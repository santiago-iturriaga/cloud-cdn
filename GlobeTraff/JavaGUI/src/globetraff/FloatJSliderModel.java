    ...
    implements BoundedRangeModel
{
     ...
     * The resolution between discrete values.
     */
    protected double defaultValue = 0.0E-6;
    ...
    public void setDoubleValue( double newValue )
    {
        ...
        if ( (newRealValue >= realMinimum) && (newRealValue <= realMaximum))
    ...
    protected void configureRealValues()
    {
        ...
        range = (int) ((apparentMaximum - apparentMinimum) / resolution);
        realMaximum = realMinimum + range;
        //System.out.println("\t"+"RealMax="+realMaximum+" RealMin="+realMinimum+" ApparentMax="+apparentMaximum+" ApparentMinimum="+apparentMinimum+" Resolution = "+resolution);
    }
