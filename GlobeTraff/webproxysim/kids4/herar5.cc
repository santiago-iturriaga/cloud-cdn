...
int main(int argc, char* argv[])
{
  ...
  printf("\n Complete overlap scenario with 4 child caches\n");
...
fprintf(out,"%d %d\n",fileid,size);
     ...
     else if (randnum <=0.5) //give it to child 2
      {	
		//line2++;
     		//if ((line2 % 1000000) == 0)
...
fprintf(out,"%d %d\n",fileid,size);
     ...
     else if (randnum <=0.75) //give it to child 3
      {	
		//line2++;
     		//if ((line2 % 1000000) == 0)
		//  printf("Request Count For Child 2 :%d\n", line2);
...
fprintf(out,"%d %d\n",fileid,size);
     ...
     else if (randnum <=1.0) //give it to child 4
      {	
		//line2++;
     		//if ((line2 % 1000000) == 0)
		//  printf("Request Count For Child 2 :%d\n", line2);
