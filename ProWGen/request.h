...
class Request {
 public:
    Request(unsigned int initFreq, unsigned int initFileSize, unsigned int fileType);
    ...
    unsigned int GetFileType();	//returnd the fileType
    
    void SetFileType(unsigned int ft);
 ...
 private:
    ...
    unsigned int fileType;		//WEB, P2P, VIDEO, OTHER
