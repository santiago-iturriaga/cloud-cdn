 ...
 * solutions.
 */
public class SinglePointCrossoverf201603 extends Crossover {
     ...
     */
    public SinglePointCrossoverf201603(HashMap<String, Object> parameters) {
        super(parameters);
    ...
    public Solution[] doCrossover(double probability,
        ...
        try {
            if (PseudoRandom.randDouble() < probability) {
                ...
                if ((parent1.getType().getClass() == CloudCDNSolutionf201603Type.class)
                        || (parent1.getType().getClass() == CloudCDNSolutionf201603Type.class)) {

                    {
                        ...
                        int valueX1;
                        int valueX2;
                        for (int i = crossoverPoint; i < parent1Int.getLength(); i++) {
                            valueX1 = (int) parent1Int.getValue(i);
                            valueX2 = (int) parent2Int.getValue(i);
                    ...
                    }
                    {
                        ...
                        Binary parent1Bin = (Binary) parent1.getDecisionVariables()[1];
                        Binary parent2Bin = (Binary) parent2.getDecisionVariables()[1];

                        int crossoverPoint = PseudoRandom.randInt(0, parent1Bin.getNumberOfBits() - 1);
                        boolean valueX1;
                        boolean valueX2;
                        for (int i = crossoverPoint; i < parent1.getNumberOfBits(); i++) {
                            valueX1 = (boolean) parent1Bin.getIth(i);
                            valueX2 = (boolean) parent2Bin.getIth(i);
                            ((Binary) offSpring[0].getDecisionVariables()[1]).setIth(i, valueX2);
                            ((Binary) offSpring[1].getDecisionVariables()[1]).setIth(i, valueX1);
                        }
                    }
