 ...
 */
public class CloudCDN_low_vlow_0_f201603 extends Experiment {
    ...
    public void algorithmSettings(String problemName, int problemIndex,
        ...
        try {
            ...
            int maxEval = 40000;
            int time_horizon = (120 * (60 * 60)); // 96 horas ~ 4 días
            ...
            */
            ...
            Logger.getLogger(CloudCDN_low_vlow_0_f201603.class.getName()).log(
                    Level.SEVERE, null, ex);
        }
    }

    public static void main(String[] args) throws JMException, IOException {
        CloudCDN_low_vlow_0_f201603 exp = new CloudCDN_low_vlow_0_f201603();
