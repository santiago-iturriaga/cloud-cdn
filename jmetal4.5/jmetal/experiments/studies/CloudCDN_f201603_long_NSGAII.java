 ...
 */
public class CloudCDN_f201603_long_NSGAII extends Experiment {

    private int instance_number;
    private String instance_type;
    private int time_horizon;

    public CloudCDN_f201603_long_NSGAII(String instance_type, int instance_number, int time_horizon) {
    ...
    public void algorithmSettings(String problemName, int problemIndex,
        ...
        try {
            ...
            Logger.getLogger(CloudCDN_f201603_long_NSGAII.class.getName()).log(
    ...
    public static void main(String[] args) throws JMException, IOException {
        ...
        CloudCDN_f201603_long_NSGAII exp = new CloudCDN_f201603_long_NSGAII(inst_type, inst_number, time_horizon);

        exp.experimentName_ = exp.getClass().getSimpleName() + "_long_NSGAII_" + exp_id;
