 ...
 */
public class CloudCDN_med_0_f201603 extends Experiment {
    ...
    public void algorithmSettings(String problemName, int problemIndex,
        ...
        try {
            ...
            Logger.getLogger(CloudCDN_med_0_f201603.class.getName()).log(
                    Level.SEVERE, null, ex);
        }
    }

    public static void main(String[] args) throws JMException, IOException {
        CloudCDN_med_0_f201603 exp = new CloudCDN_med_0_f201603();
