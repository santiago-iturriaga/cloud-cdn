 ...
 */
public class CloudCDN_f201603_200k_NSGAII extends Experiment {

    private int instance_number;
    private String instance_type;
    private int time_horizon;

    public CloudCDN_f201603_200k_NSGAII(String instance_type, int instance_number, int time_horizon) {
    ...
    public void algorithmSettings(String problemName, int problemIndex,
        ...
        try {
            ...
            Logger.getLogger(CloudCDN_f201603_200k_NSGAII.class.getName()).log(
    ...
    public static void main(String[] args) throws JMException, IOException {
        ...
        CloudCDN_f201603_200k_NSGAII exp = new CloudCDN_f201603_200k_NSGAII(inst_type, inst_number, time_horizon);
