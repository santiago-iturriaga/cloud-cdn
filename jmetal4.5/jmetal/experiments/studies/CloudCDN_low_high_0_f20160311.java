 ...
 */
public class CloudCDN_low_high_0_f20160311 extends Experiment {
    ...
    public void algorithmSettings(String problemName, int problemIndex,
        ...
        try {
            ...
            */
            ...
            Logger.getLogger(CloudCDN_low_high_0_f20160311.class.getName()).log(
                    Level.SEVERE, null, ex);
        }
    }

    public static void main(String[] args) throws JMException, IOException {
        CloudCDN_low_high_0_f20160311 exp = new CloudCDN_low_high_0_f20160311();
