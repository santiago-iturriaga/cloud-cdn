 ...
 */
public class CloudCDN_f201603b50 extends Experiment {
    ...
    public CloudCDN_f201603b50(String instance_type, int instance_number, int time_horizon,
            int max_evals) {
    ...
    public void algorithmSettings(String problemName, int problemIndex,
        ...
        try {
            ...
            problemParams = new Object[]{"CloudCDNSolutionf201603b50Type",
                "../Instances/",
            ...
            Logger.getLogger(CloudCDN_f201603b50.class.getName()).log(
    ...
    public static void main(String[] args) throws JMException, IOException {
        ...
        CloudCDN_f201603b50 exp = new CloudCDN_f201603b50(inst_type, inst_number, time_horizon, max_evals);
