 ...
 */
public class CloudCDN_f201603b100 extends Experiment {
    ...
    public CloudCDN_f201603b100(String instance_type, int instance_number, int time_horizon,
            int max_evals) {
    ...
    public void algorithmSettings(String problemName, int problemIndex,
        ...
        try {
            ...
            Logger.getLogger(CloudCDN_f201603b100.class.getName()).log(
    ...
    public static void main(String[] args) throws JMException, IOException {
        ...
        CloudCDN_f201603b100 exp = new CloudCDN_f201603b100(inst_type, inst_number, time_horizon, max_evals);
