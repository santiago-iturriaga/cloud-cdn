...
public abstract class Experiment {
    ...
    private void checkExperimentDirectory() {
        ...
        System.out.println("Experiment directory: " + experimentBaseDirectory_.toString());
    } // checkDirectories
    ...
    public synchronized int[] getNextProblem() {
        ...
        if (this.problemIndex < this.problemList_.length - 1) {
            this.problemIndex++;
        } else if (this.algorithmIndex < this.algorithmNameList_.length - 1) {
            this.algorithmIndex++;
            this.problemIndex = 0;
        } else if (this.irunIndex < this.independentRuns_ - 1) {
            this.irunIndex++;
            this.problemIndex = 0;
