#postscript("CloudCDN_f201603_low_0_43200.EPSILON.Boxplot.eps", horizontal=FALSE, onefile=FALSE, height=8, width=12, pointsize=10)
png("CloudCDN_f201603_low_0_43200.EPSILON.Boxplot.png", height=512, width=512, pointsize=20)
